...
export async function downloadSecurityReportPdf(input, options = {}) {
  ...
  infoBox(
    recommendation.cta,
    "Hansen IT kan lage en konkret tiltakspakke basert på funnene. Dette kan gjøres som fjernarbeid eller avtalt gjennomgang. Fix with Hansen IT betyr kontrollert oppgave- og tilbudsflyt, ikke automatisk retting.",
    COLORS.blue,
    34
  );
