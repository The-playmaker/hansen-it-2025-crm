export const docsNavGroups = [
  ...
  },
  {
    title: "Governance",
    items: [
      { label: "ADR", href: "/admin/docs/adr-rfc#adr", activePath: "/admin/docs/adr-rfc" },
