...
export const ideaStatuses = ["parked", "reviewing", "active", "dropped", "done"];
...
export const phoenixSiteContentFallback = {
  ...
  services: [
    ...
    {
      title: "IoT-løsninger",
      description: "Smarte sensorer og overvåking som gir bedre kontroll over drift og miljø.",
      href: "/iot",
...
export const phoenixMockData = {
  ...
  ideas: [
    { id: "ide-1", title: "Standard onboarding-sjekkliste", description: "Fast sjekkliste for nye kunder.", category: "Drift", status: "reviewing", priority: "normal" },
    { id: "ide-2", title: "Kundehelse-score", description: "Enkel score basert på oppgaver, avtale og oppfølging.", category: "CRM", status: "parked", priority: "lav" },
    { id: "ide-3", title: "AI-oppsummering av notater", description: "Ikke v1. Parker til datagrunnlaget er bedre.", category: "AI", status: "parked", priority: "lav" }
  ]
};
