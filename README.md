...
Dokumentasjon
Setup: miljøvariabler, Vercel og lokal kjøring.
Database: Supabase-tabeller, migrations og datamodell.
Modules: CRM, Scan, Reports, Quote Portal, CMS og Ideas.
Security: service role, RLS, token-portaler og scan authorization.
Implementation Notes: historikk, v1-notater, Kanban, Teams og n8n.
Phoenix Docs: levende utviklerportal og arkitekturdokumentasjon.
Sikkerhetsnotat
